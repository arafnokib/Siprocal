# Your existing backend code (main.py or app.py)
import asyncio
import json
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:8000"],  # React's default port
...
# WebSocket endpoint
@app.websocket("/ws")  # Choose a clear endpoint
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            # Process message (your chatbot logic)
        ...
        async def handle_websocket(self, websocket: WebSocket):
            ...
            try:
                ...
                while True:
                    ...
                    return f"Processed: {assistant_response}"
